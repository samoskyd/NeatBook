        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserSex = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleGenre = table.Column<int>(type: "int", nullable: false),
                    Language = table.Column<int>(type: "int", nullable: false),
                    AgeRestrictions = table.Column<bool>(type: "bit", nullable: false),
                    AuthorRights = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikesArticles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLikesArticles_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserLikesArticles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserLikesBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserLikesBooks_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserLikesBooks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLikesArticles_ArticleId",
                table: "UserLikesArticles",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikesArticles_UserId",
                table: "UserLikesArticles",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikesBooks_BookId",
                table: "UserLikesBooks",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikesBooks_UserId",
                table: "UserLikesBooks",
                column: "UserId");
        }
